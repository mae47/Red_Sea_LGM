...
one_param_input<-data.frame(c=sim_params$Nsource_exp,sim_summary_stats)
...
Nsource_param_rf <- one_param_rf
predict_output_Nsource <- predict(one_param_rf,obs=obs_summary_stats,training = one_param_input)
rm(one_param_rf)
#save environment
save.image(paste0(base_path,"/analysis/abcrf/environments/Nsource_param_rf_11092023.RData"))
