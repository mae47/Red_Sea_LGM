...
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$split_IO, predict_output_split_IO$med, col="red", main="split_IO_median", xlim=c(0,160), ylim=c(0,160), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$split_IO, predict_output_split_IO$expectation, col="red", main="split_IO_mean", xlim=c(0,160), ylim=c(0,160), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$resize, predict_output_resize$med, col="red", main="resize_median", xlim=c(0,100), ylim=c(0,100), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$resize, predict_output_resize$expectation, col="red", main="resize_mean", xlim=c(0,100), ylim=c(0,100), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
...
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$tanc_exp, predict_output_tanc_exp$med, col="red", main="tanc_exp_median", xlim=c(4,5.4), ylim=c(4,5.4), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2) 
plot(test_obs_data$tanc_exp, predict_output_tanc_exp$expectation, col="red", main="tanc_exp_mean", xlim=c(4,5.4), ylim=c(4,5.4), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2) 
...
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$gr, predict_output_gr$med, col="red", main="gr_median", xlim=c(-0.065,0), ylim=c(-0.065,0), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$gr, predict_output_gr$expectation, col="red", main="gr_mean", xlim=c(-0.065,0), ylim=c(-0.065,0), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
