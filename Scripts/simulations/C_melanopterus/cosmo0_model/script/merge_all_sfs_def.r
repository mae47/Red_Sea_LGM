...
base_path<-"/home/mae47/rds/hpc-work/C_melanopterus/simulations/cosmo0_model"
...
writeLines(paste("Nsource","Nsource_exp","Nanc","Nanc_exp","Npop_RS","Npop_RS_exp","Npop_IO","Npop_IO_exp","split_IO","tanc","trec","tstop","tleng","gr","mig","mig_exp",sep="\t"), con=final_def, sep="\n")
