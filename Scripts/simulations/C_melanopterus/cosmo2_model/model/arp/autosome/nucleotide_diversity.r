...
t<-read.table("/home/mae47/rds/hpc-work/C_melanopterus/simulations/cosmo2_model/island_1/model/arp/autosome/outSumStats.txt", header=T)
...
write.table(sumstats, file="/home/mae47/rds/hpc-work/C_melanopterus/simulations/cosmo2_model/island_1/model/final/pi", col.names=F, row.names=F, quote=F, sep="\t")
