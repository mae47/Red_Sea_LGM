...
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$Npop_IO_exp, predict_output_Npop_IO_exp$med, col="red", main="Npop_IO_exp_median", xlim=c(3.95,6), ylim=c(3.95,6), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$Npop_IO_exp, predict_output_Npop_IO_exp$expectation, col="red", main="Npop_IO_exp_mean", xlim=c(3.95,6), ylim=c(3.95,6), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
...
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$tanc_exp, predict_output_tanc_exp$med, col="red", main="tanc_exp_median", xlim=c(4.3,5.5), ylim=c(4.3,5.5), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2) 
plot(test_obs_data$tanc_exp, predict_output_tanc_exp$expectation, col="red", main="tanc_exp_mean", xlim=c(4.3,5.5), ylim=c(4.3,5.5), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2) 
...
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$gr, predict_output_gr$med, col="red", main="gr_median", xlim=c(-0.042,0), ylim=c(-0.042,0), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
plot(test_obs_data$gr, predict_output_gr$expectation, col="red", main="gr_mean", xlim=c(-0.042,0), ylim=c(-0.042,0), xlab="simulated values", ylab="estimated values",cex.main=1,cex.lab=0.9,cex.axis=0.9)
abline(a=0, b=1, col="black", lwd=2)
