...
envs <- c("Nanc_param_rf_11092023_Dt.RData","Nbott_param_rf_11092023_Dt.RData","Npop_RS_param_rf_11092023_Dt.RData","Npop_IO_param_rf_11092023_Dt.RData","resize_mod_param_rf_11092023_Dt.RData","tanc_param_rf_11092023_Dt.RData","tleng_param_rf_11092023_Dt.RData","gr_param_rf_11092023_Dt.RData","mig_param_rf_11092023_Dt.RData")
#pink 10k Da sims
#envs2 <- c("resize_mod_param_rf_11092023_Da.RData","gr_param_rf_11092023_Da.RData")
envs2 <- c("Nanc_param_rf_11092023_Da.RData","Nbott_param_rf_11092023_Da.RData","Npop_RS_param_rf_11092023_Da.RData","Npop_IO_param_rf_11092023_Da.RData","resize_mod_param_rf_11092023_Da.RData","tanc_param_rf_11092023_Da.RData","tleng_param_rf_11092023_Da.RData","gr_param_rf_11092023_Da.RData","mig_param_rf_11092023_Da.RData")
#green 10k Pm sims
#envs3 <- c("resize_mod_param_rf_11092023_Pm.RData","gr_param_rf_11092023_Pm.RData")
envs3 <- c("Nanc_param_rf_11092023_Pm.RData","Nbott_param_rf_11092023_Pm.RData","Npop_RS_param_rf_11092023_Pm.RData","Npop_IO_param_rf_11092023_Pm.RData","resize_mod_param_rf_11092023_Pm.RData","tanc_param_rf_11092023_Pm.RData","tleng_param_rf_11092023_Pm.RData","gr_param_rf_11092023_Pm.RData","mig_param_rf_11092023_Pm.RData")
#blue 10k Dm sims
...
envs4 <- c("Nanc_param_rf_11092023_Cm.RData","Nbott_param_rf_11092023_Cm.RData","Npop_RS_param_rf_11092023_Cm.RData","Npop_IO_param_rf_11092023_Cm.RData","resize_mod_param_rf_11092023_Cm.RData","tanc_param_rf_11092023_Cm.RData","tleng_param_rf_11092023_Cm.RData","gr_param_rf_11092023_Cm.RData","mig_param_rf_11092023_Cm.RData")
...
for (i in c(1,2,3,4)) {
write.table((matrix(ncol=7, nrow=0)), paste0("/home/mae47/rds/hpc-work/RAD_seq/D_trimaculatus/NRS_DGA/analysis/abcrf_compare/output/abcrf_param_est_",i), col.names=c("expectation","med","variance","variance.cdf","quantiles1","quantiles2","post.NMAE.mean")) }
...
#resize doesn't have to be adjusted for generation time or by a factor of 10 because it is a ratio of pop sizes. Also didnt include prior, as wasnt selected from a range. x axis logged
  else if (str_sub(param_name, end=6) == "resize") {
  ...
  p<- ggplot() +
	...
	#geom_density(data = prior, aes(x = x), color = 'grey') +
        ...
        labs(x=expr(paste(!!param_name," (Nbott/Npop_RS; logged)"))) +
...
g<-arrangeGrob(grobs=lapply(plots,"+",margin), nrow=3, ncol=3)
...
ggsave(file="/home/mae47/rds/hpc-work/RAD_seq/D_trimaculatus/NRS_DGA/analysis/abcrf_compare/output/multiplot_filtered.pdf", g, width=10, height=10)
...
param_name_list <- c("Nanc", "Nbott", "Npop_RS", "Npop_IO", "resize_mod", "tanc", "tleng", "gr", "mig") #NB no longer just a subset of params..
...
file.rename("abcrf_param_est_1","abcrf_param_est_filtered_Dt")
file.rename("abcrf_param_est_2","abcrf_param_est_filtered_Da")
file.rename("abcrf_param_est_3","abcrf_param_est_filtered_Pm")
#file.rename("abcrf_param_est_4","abcrf_param_est_Dm")
file.rename("abcrf_param_est_4","abcrf_param_est_filtered_Cm")
